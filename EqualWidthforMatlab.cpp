...
#include<stdlib.h>
#include<stdio.h>
void findMinAndMax(double *minP,double *maxP,double *arrayParameter,long long lengthOfArray){
    for(long long iterator1=0;iterator1<lengthOfArray;iterator1++){
